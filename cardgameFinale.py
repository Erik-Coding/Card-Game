...
def setVars(): # define setVars function to set the variables
...
def tellWins(oneWins, twoWins): # set tellWins function with oneWIns and twoWins as parameters
    print(f"\nIt is currently {oneWins} - {twoWins}. (Player 1) - (Player 2)\n") # print how many wins each player has

while True: # Runs the game unless told not to
    

    introAsk = intro() # call into function
    ...
    for rounds in range(5): # makes the game last 5 rounds
        ...
        while playerOneTurn: # P1 Turns
            ...
            while True: # Drawing Section for P1
                ...
                if (riskQuestion): # will draw another card if you risked
                    ...
                    if (plrTotalCheck == "Over"): # if plrTotal check equals "over"
                        break
                    elif (plrTotalCheck == "Perfect"): # else if plrTotalCheck equals "perfect"
                        break
        ...
        while playerOneTurn == False: # P2s turn
            ...
            playerTwoTotal = drewCardStart2 # set first card to p2 total
            ...
            while True: # Drawing Section for P2
                ...
                if (riskQuestion):  # if riskquestion is true
                    print("\nOkay, you risked! We will draw another card!")
                    time.sleep(2)
                    ...
                    if (plrTotalCheck == "Over"): # if plrTotal check is 'over'
                        break
                    elif (plrTotalCheck == "Perfect"): # else if plrTotal is 'perfect'
                        break
        ...
        # checking who won
        checkWhoWon(playerOneTotal, playerTwoTotal) # calls checkWhoWon function to check who wins the game

        time.sleep(1)
        tellWins(playerOneWins, playerTwoWins)
